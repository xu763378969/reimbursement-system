...
const DEFAULT_TOKEN =
  "eyJhbGciOiJIUzUxMiJ9.eyJsb2dpbl91c2VyX2tleSI6IjQzZGRmNjc2LTZlM2UtNGM0OS1hNWM1LTNiYWQ0ZTkzYzg1OCJ9.IGGYEPnpLfKeZE8sJqgYj5T877qcU87ngaNroBkxaGzy65xODw-WhjjPJedx19xoa618V7to4ofS-oW3avOqlg";
...
export const getUserInfo = (req: Request, res: Response) => {
  ...
  return res.json({
    ...
    data: {
      user:
        req.header("Authorization") == "admin-token" ? userList[0] : userList[1]
    }
  });
};
